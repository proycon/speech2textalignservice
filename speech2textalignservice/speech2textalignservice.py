...
SYSTEM_ID = "speech2textalignservice"
#System name, the way the system is presented to the world
SYSTEM_NAME = "Speech-to-text alignment service"

#An informative description for this system (this should be fairly short, about one paragraph, and may not contain HTML)
SYSTEM_DESCRIPTION = "Speech-to-text alignment"
...
PROFILES = [
    Profile(
        ...
        OutputTemplate('HTML', HTMLFormat,'Visualisation of text with timed transcriptions',
            removeextension=".wav",
            extension='.html',
            multi=True
        )
...
#
COMMAND = WEBSERVICEDIR + f"/speech2textalignservice_wrapper.sh $STATUSFILE $INPUTDIRECTORY $OUTPUTDIRECTORY $PARAMETERS"
